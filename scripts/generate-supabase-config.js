// Generates assets/js/supabase-config.js from environment variables (Netlify build).
...
const content = `// Auto-generated — do not edit. Set SUPABASE_URL and SUPABASE_ANON_KEY in Netlify.
